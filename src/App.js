...
import { 
  Search, Phone, Mail, BarChart, Network, 
  Home, Info, Globe, Users, LayoutGrid, ChevronDown,
  ChevronLeft, ChevronRight, PlayCircle, Accessibility
} from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative w-20 h-20 rounded-full bg-white border-2 border-red-600 flex items-center justify-center overflow-hidden flex-shrink-0">
               ...
               <div className="absolute top-1 w-full text-[6px] text-center font-bold text-red-600 tracking-tighter" style={{ transform: 'rotate(-25deg) translateY(-2px)'}}>KOLEJ MATRIKULASI</div>
               <div className="absolute bottom-1 w-full text-[6px] text-center font-bold text-blue-800 tracking-tighter" style={{ transform: 'rotate(25deg) translateY(2px)'}}>KEDAH</div>
            </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="hidden lg:flex items-center gap-3 text-indigo-900">
              <button className="hover:text-blue-600 transition-colors" aria-label="Sitemap"><Network size={18} /></button>
              <button className="hover:text-blue-600 transition-colors" aria-label="Phone"><Phone size={18} /></button>
              <button className="hover:text-blue-600 transition-colors" aria-label="Mail"><Mail size={18} /></button>
              <button className="hover:text-blue-600 transition-colors" aria-label="Statistics"><BarChart size={18} /></button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 overflow-x-auto no-scrollbar">
          <ul className="flex items-center justify-center md:justify-center min-w-max">
            ...
            <li className="relative group">
              <a href="#" className="flex items-center gap-2 px-6 py-4 text-orange-500 text-sm font-medium border-b-2 border-orange-500 hover:text-orange-400 transition-colors">
                <Home size={16} />
                <span>Utama</span>
              </a>
            </li>
            ...
            {/* Other Items */}
            <li className="relative group">
              <a href="#" className="flex items-center gap-2 px-6 py-4 text-gray-200 text-sm font-medium hover:text-white transition-colors border-b-2 border-transparent hover:border-gray-400">
                <Info size={16} />
                <span>Kemasukan Pelajar 2026/2027</span>
              </a>
            </li>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 pb-12">
            ...
            <div className="relative group cursor-pointer rounded-xl overflow-hidden shadow-md aspect-video">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-black/60 p-6 flex flex-col justify-between">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-bold text-lg leading-tight">VIDEO KORPORAT KOLEJ MATRIKULASI KEDAH</h3>
                ...
                <div className="text-white">
                  <h4 className="text-4xl font-extrabold uppercase tracking-widest opacity-90">Dewan</h4>
                </div>
              </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex overflow-hidden">
              ...
              <div className="w-2/5 md:w-1/3 relative bg-gray-50 flex items-end justify-center pt-6 px-4" 
                   style={{
                ...
                <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'linear-gradient(45deg, transparent 48%, #cbd5e1 49%, #cbd5e1 51%, transparent 52%)', backgroundSize: '20px 20px' }}></div>
              ...
              <div className="flex-1 p-6 md:p-8 flex flex-col justify-center">
                <h3 className="text-sm font-extrabold text-gray-900 uppercase tracking-wider mb-2">Pengarah</h3>
                <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                  Puan Zuriah binti Sulaiman, <span className="text-xs text-gray-500 ml-1">A.M.P</span>
                </p>
                ...
                <p className="text-gray-500 text-sm mt-3 pt-3 border-t border-gray-100">
                  Tel : <span className="font-medium text-gray-600 hover:text-indigo-600 cursor-pointer transition-colors">04-9286100</span>
                </p>
              </div>
            </div>
          </div>
